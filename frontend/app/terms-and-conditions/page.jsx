      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="mb-6 px-5 py-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
          ...
          <p className="text-sm text-amber-800 leading-relaxed">
            Our full Terms & Conditions are currently being finalized. The sections below represent
            our current operating guidelines. For any questions, contact us at{" "}
            <a href="mailto:support@inscovia.com" className="font-medium underline">
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-6 sm:p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing and using Inscovia's website and services, you accept and agree to be
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              of your account at{" "}
              <a href="mailto:support@inscovia.com" className="text-indigo-600 hover:underline">
                support@inscovia.com
              </a>
            </p>
          </section>

          {/* ✅ KEPT — important disclaimer */}
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Training Center Listings</h2>
            <p className="text-gray-700 leading-relaxed">
              Inscovia acts as a platform to connect users with training centers. We do not directly
              provide training services. While we strive to ensure the accuracy of information listed
              on our platform, we cannot guarantee the quality of services provided by training
              centers. Users are advised to conduct their own research before enrolling in any course.
            </p>
          </section>

          {/* ✅ KEPT — important for review system */}
          <section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              The service and its original content, features, and functionality are owned by Inscovia
          ...
          {/* ✅ KEPT — important liability protection */}
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              expressed or implied, regarding the operation of our service or the information, content,
              or materials included on our website. To the fullest extent permissible by applicable
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Inscovia shall not be liable for any indirect, incidental, special, consequential, or
              punitive damages resulting from your access to or use of our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              or controlled by Inscovia. We have no control over and assume no responsibility for
          ...
          {/* ✅ REMOVED: Governing Law (Bangalore jurisdiction claim — wrong, risky) */}
          {/* ✅ REMOVED: Contact section with fake phone and address */}
