      ...
      <main className="max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-6 pb-20 md:pb-8">
        ...
        <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm text-blue-800">
            ...
            <span>You're viewing your profile as students see it</span>
          </div>
          <Link
            href="/institute/dashboard/edit"
            className="px-3 py-1.5 bg-accent text-white text-sm font-medium rounded-lg hover:bg-accent/90"
          >
            Edit Profile
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg sm:rounded-xl shadow-sm overflow-hidden border">
          ...
          <div className="pt-10 sm:pt-12 px-3 sm:px-4 pb-4">
            ...
            <div className="mt-1.5 flex items-center gap-1.5 text-sm text-gray-600">
              ...
              <span className="truncate">{institute.city}, {institute.state}</span>
            </div>
            ...
            <section className="mt-4">
              ...
              {categoriesWithCourses.length > 0 ? (
                ...
                <div className="text-center py-8 border-2 border-dashed rounded-lg">
                  <p className="text-sm text-gray-500 mb-2">No courses added yet</p>
                  <Link
                    href="/institute/dashboard/courses"
            ...
            {center?.gallery && center.gallery.length > 0 && (
              <section className="mt-4">
                <div className="flex items-center justify-between mb-2">
                  <h2 className="text-base font-semibold text-gray-900">
                    Gallery {center.gallery.length > 4 && `(${center.gallery.length})`}
                  </h2>
                  <Link
                    href="/institute/dashboard/gallery"
                    className="text-accent hover:text-accent/80 text-xs font-medium"
                  >
                    {center.gallery.length > 4 ? 'View All' : 'Edit'}
                  </Link>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {center.gallery.slice(0, 4).map((img, i) => (
                    <div key={i} className="relative">
                      ...
                      />
                      {i === 3 && center.gallery.length > 4 && (
                        <div className="absolute inset-0 bg-black/60 rounded-lg flex items-center justify-center">
                          <span className="text-white font-semibold text-lg">
                            +{center.gallery.length - 4}
                          </span>
                        </div>
                      )}
                    </div>
