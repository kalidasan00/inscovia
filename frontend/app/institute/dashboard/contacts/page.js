          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Indian mobile number without country code</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <ul className="list-disc list-inside space-y-1 text-blue-700">
                  <li>Add complete URLs starting with https://</li>
                  <li>Social links help students find and connect with you easily</li>
