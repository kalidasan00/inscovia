            ...
            {step === 2 && (
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 mt-2">We've sent a 6-digit code to<br /><span className="font-semibold text-gray-900">{formData.email}</span></p>
                </div>
                ...
                <form onSubmit={handleVerifyAndRegister} className="space-y-6">
                  ...
                  <div className="text-center">
                    <button type="button" onClick={() => setStep(1)} className="text-sm text-gray-600 hover:text-gray-900">← Back to form</button>
                  </div>
                </form>
              </>
            )}
