                  ...
                  <div className={`w-10 h-10 ${course.color} rounded-lg flex items-center justify-center mx-auto mb-2`}>
                    {typeof Icon === 'string' ? (
                      Icon === 'shield' ? (
                        ...
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-10 5.002 5.002 0 00-9.78 2.096A4.001 4.001 0 003 15z" />
                        </svg>
                      ) : Icon === 'layout' ? (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {[
              ...
              <Link
                key={exam.name}
                href={`/centers?q=${encodeURIComponent(exam.name)}`}
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
              {cities.slice(0, 18).map((city) => (
                <Link
                  key={city}
                  href={`/centers?city=${encodeURIComponent(city)}`}
        ...
        <section className="max-w-6xl mx-auto px-4 py-8">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-center">
            ...
            <p className="text-white/90 mb-6">
              Browse verified training centers across India
            </p>
            <Link
              href="/centers"
