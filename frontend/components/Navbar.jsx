  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      <div className="relative">
        ...
        <input ref={inputRef} id="nav-search" type="search" role="combobox"
          aria-expanded={dropdownOpen} aria-haspopup="listbox" aria-autocomplete="list"
        ...
        {query && (
          <button onClick={() => { setQuery(""); setDropdown(false); setAiResults([]); abortRef.current?.abort(); }}
  ...
  return (
    <div ref={ref} className="relative flex-shrink-0">
      <button onClick={() => setOpen((v) => !v)}
        ...
        aria-expanded={open} title={city || "Set city"}
      ...
      {open && (
        <div role="dialog" aria-label="Location settings"
          ...
          <form onSubmit={handleManualSet} className="flex gap-2">
            <input type="text" value={manualInput} onChange={(e) => setManual(e.target.value)}
  ...
  return (
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm" aria-label="Main navigation">
      ...
      <div className="lg:hidden">
        <div className="max-w-7xl mx-auto px-3 sm:px-4">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-0.5">
              ...
              <button onClick={() => { setMobileSearch((v) => !v); setMenuOpen(false); }}
              ...
              <button onClick={() => { setMenuOpen((v) => !v); setMobileSearch(false); }}
                aria-label={menuOpen ? "Close menu" : "Open menu"}
                aria-expanded={menuOpen} aria-controls="mobile-nav-menu"
        ...
        {menuOpen && (
          <>
            <div className="fixed inset-0 top-14 sm:top-16 bg-black/30 z-40"
              onClick={() => setMenuOpen(false)} aria-hidden="true" />
            <div id="mobile-nav-menu" role="dialog" aria-label="Navigation menu"
